...
public class EscenaCurtaActivity extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.btSignOutMenu) {
            ...
            //-------------------------------------------------------------------
            AlertDialog.Builder dialegPassword = new AlertDialog.Builder(EscenaCurtaActivity.this);
            LayoutInflater factory = LayoutInflater.from(EscenaCurtaActivity.this);
